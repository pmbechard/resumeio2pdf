...
If you're using this as a digital resume, you will certainly want it to be searchable. For this functionality, you must download Tesseract. Installation instructions can be found at [here](https://tesseract-ocr.github.io/tessdoc/Installation.html). After installing Tesseract, generate your resume in the same way shown above.
